...
namespace GuessTheNumber
{
    class Game
    {
        //Lager guess class til object inni denne objecten
        private static readonly Random Random = new Random();

        //field
        private readonly int _correctNumber;
        private readonly List<Guess> _guesses; //liste 

        //hvis _guesses.Count er større enn 0 og (siste) _guesses er true ?????????
